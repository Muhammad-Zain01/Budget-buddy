...
import Pad from './components/calc-pad'
...
export const CalculatorApp: React.FC<CalculatorProps> = ({ getResult }) => {
    ...
    const onGetMemory = () => getResult(result)
